...
export EDITOR="nvim"
export NIX_USER_CONF_FILES="$XDG_CONFIG_HOME/nix/nix.conf"
...
if test ! -r "$NIX_SSL_CERT_FILE"; then
  ...
  export NIX_SSL_CERT_FILE="/nix/store/d7b0vzrq8ps3allsr3md1pmilficdvw7-nss-cacert-3.119.1/etc/ssl/certs/ca-bundle.crt"
fi
...
export nix_state_home="${XDG_STATE_HOME-$HOME/.local/state}/nix"
