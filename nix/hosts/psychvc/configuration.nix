...
in {
  ...
  host.users = {
    osx = {
      ...
      sshKeys = [
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGhFHbAlNeXCS5axcUWmn6yTR8FKv/SJ7RlyeGxqga35"
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIErVTbtwztvqi2vfZ9ScWpi+8xd8JNYBQCbFt/1A/7GF"
      ];
    };
  };
